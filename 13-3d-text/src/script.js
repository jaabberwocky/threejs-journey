...
const matcapTexture = textureLoader.load('/textures/matcaps/matcapblue.png')
...
renderer.setSize(sizes.width, sizes.height)
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2))
renderer.setClearColor(0x0c013b)

/**
 * Animate
 */
const clock = new THREE.Clock()
let directionCameraUp = true;
...
const tick = () => {
    ...
    if (camera.position.y > 10 || camera.position.y < -10) {
        directionCameraUp = !directionCameraUp
    }
